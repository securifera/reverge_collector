...
class Feroxbuster(data_model.WaluigiTool):
    ...
    def __init__(self) -> None:
        ...
        self.scan_order = 10
        self.args = "--rate-limit 50 -s 200 -n --auto-bail --parallel 10 --scan-limit 10"
...
class FeroxScan(luigi.Task):
    ...
    def run(self) -> None:
        ...
        # Build url_to_id_map, skipping URLs that already have specific paths
        ...
        if url_to_id_map:
            ...
            # No targets — write an empty metadata file so Luigi marks the task complete
            results_dict = {
                'url_to_id_map': {},
                'output_file': None,
            }
