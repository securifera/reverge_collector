...
class TestCrapsecretsScan:
    ...
    def test_crapsecrets_scan_success(self, recon_manager):
        ...
        crap_secrets_response = {
            ...
            'custom_args': None,
            'output': {
                'target': 'http://192.168.110.131/',
                'results': [
                    {
                        'detecting_module': 'ASPNET_Viewstate',
                        'product_type': 'ASP.NET Viewstate',
                        'product': 'Viewstate: /wEPDwULLTEwNDcyMDA1MTQPZBYCAgMPZBYCZg8VATtSZWdpc3RyeUtleTogNC42LjIgLS0tIEVudmlyb25tZW50LlZlcnNpb246IDQuMC4zMDMxOS40MjAwMGRkjez32gk9qLoRFKNaUp+OdqsYYW4= Generator: CA0B0334',
                        'secret_type': 'ASP.NET MachineKey',
                        'location': 'body - URL: http://192.168.110.131/',
                        'type': 'SecretFound',
                        'secret': 'ValidationKey: [3DA7A917DF10B92A642434F1532E639C8EB81E8667289F2068A18B24DD8269AE7759FE23B3158EAC6955308D42B5B74CBD49CEDB3F3929D6C769DC4081CC1986] ValidationAlgo: [SHA1]',
                        'severity': 'CRITICAL',
                        'details': 'Mode: DotNetMode.DOTNET40_LEGACY\nURL: [http://192.168.110.131/]',
                    },
                    {
                        'detecting_module': 'ASPNET_Resource',
                        'product_type': 'ASP.NET Resource',
                        'product': 'Resources: OMvcSUjTz2zWsB/tBOZcJg+Gghhv1MSHOS9t5HZMimKN/jdZT/tveHqCP6Ukevgccg7Inx6RdN7Alk0mhpIIiT/D/8c9gthPjS28OXcb5HB1blt5wdO4/QYf/U5o+iHGjwztTg==',
                        'secret_type': 'ASP.NET MachineKey',
                        'location': 'body - URL: http://192.168.110.131/',
                        'type': 'SecretFound',
                        'secret': 'ValidationKey: [3DA7A917DF10B92A642434F1532E639C8EB81E8667289F2068A18B24DD8269AE7759FE23B3158EAC6955308D42B5B74CBD49CEDB3F3929D6C769DC4081CC1986] ValidationAlgo: [SHA1 or 3DES or AES] EncryptionKey: [D0CC8D9BC98B9C36023B0DD7271FC8405E32007986A3D69C2CE716EED106BFA6] EncryptionAlgo: [AES]',
                        'severity': 'HIGH',
                        'details': 'Mode: DotNetMode.DOTNET40_LEGACY\nURL: [http://192.168.110.131/]',
                    },
                ],
        ...
        with patch.object(ReconManager, 'get_scheduled_scan', return_value=scan_data):
            with patch(
                'reverge_collector.crapsecrets_scan.request_wrapper',
                return_value=crap_secrets_response,
            ):
                scheduled_scan_obj = ScheduledScan(scan_thread, sched_scan_arr)
