...
def test_nmap_scan_success(recon_manager):
    ...
    tool_inst = {'id': 'a9866b94f7104754bd161c1ab7cbf0cd', 'collection_tool': {'wordlists': [], 'name': 'nmap', 'args':
                                                                               '-sV --script +ssl-cert --script-args ssl=True', 'tool_type': 2, 'scan_order': 2, 'api_key': None, 'id': 'f35c684c61da412c8aaf7d386540f664'}, 'args_override': None,
...
def test_nmap_import_success(recon_manager):
    ...
    try:
        ...
        with patch.object(ReconManager, 'get_scheduled_scan', return_value=scan_data):
            ...
            with patch.object(ReconManager, 'import_data', return_value={}):
                ...
                assert result == True
                output_json = "%s/nmap-outputs/tool_import_json" % (
                    output_dir)
