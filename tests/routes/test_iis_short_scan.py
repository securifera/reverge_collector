    ...
    def test_iis_short_scan_success(self, recon_manager):
        ...
        with patch.object(ReconManager, 'get_scheduled_scan', return_value=scan_data):
            ...
            with open(output_file, 'r') as f:
                ...
                assert isinstance(port_entry_list, list) and len(port_entry_list) > 0
                assert (
                    port_entry_list[0]['target'] == 'https://www.securifera.com/'
                    or port_entry_list[0]['target'] == 'https://52.4.7.15/'
                )
