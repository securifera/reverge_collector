...
class TestPyshotScan:
    ...
    def test_pyshot_scan_success(self, recon_manager):
        ...
        with patch.object(ReconManager, 'get_scheduled_scan', return_value=scan_data):
            ...
            input_conf = '%s/%s-outputs/screenshots.meta' % (output_dir, self.TOOL_NAME)
    ...
    def test_pyshot_import_success(self, recon_manager):
